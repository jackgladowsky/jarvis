...
export function goalPrompt(goal: GoalState, iteration: number): string {
  return [
    ...
    "Use the assigned git worktree only.",
    "Goal children must never push, merge, deploy, restart services, or edit the main checkout. No explicit request or mailbox message can grant an exception; main JARVIS is the gate.",
    "Destructive operations still require explicit owner approval in the task mailbox.",
