...
Use this skill whenever Jack refers to durable facts, past sessions, projects, decisions, preferences, pending work, or what JARVIS should remember.
...
- `environment.md` — runtime-discovered facts about the M710q not already in `AGENTS.md`.
...
When in doubt, read. A redundant read is cheap; missed memory looks like amnesia. Not a strong brand.
...
- Durable fact about Jack → edit `about.md` or `preferences.md`.
...
```markdown
## Services
- Minecraft: docker container `minecraft-fabric`, world at /path/to/world.
